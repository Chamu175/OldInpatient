package customClasses
{
	...
	public class CustomCallout extends MadSprite
	{
		 ...
		 */
		public function CustomCallout(screen:Sprite, xx:Number, yy:Number, arrowPosition:Number = 0, colour:uint = 0x666666, alt:Boolean = false, words:Vector.<String> = null) {
