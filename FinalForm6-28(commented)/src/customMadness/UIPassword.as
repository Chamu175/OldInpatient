package customMadness
{
	...
	public class UIPassword extends Sprite
	{
		
		protected static const SHADOW_OFFSET:Number = 1.0;
		protected static const FORMAT:TextFormat = new TextFormat("_sans", 28, 0x333333);
		...
		public function UIPassword(screen:Sprite, xx:Number, yy:Number, text:String, colours:Vector.<uint> = null, alt:Boolean = false, prompt:String="", promptColour:uint = 0x999999)
		{
